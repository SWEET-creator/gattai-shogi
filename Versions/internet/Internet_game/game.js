...
function init(){
	...
	//koma_list.push(new KNKN(3,4,0));
	//koma_list.push(new GNGN(4,4,0));
	//koma_list.push(new KYKY(5,4,0));
...
function move_koma(){
	...
	if (target_obj != null){
		...
		send_inf["distination"] = [mouse_x, mouse_y];
