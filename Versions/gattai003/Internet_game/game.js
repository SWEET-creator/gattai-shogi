			...
			if (koma_list[i] != this && koma_list[i].x == this.x && koma_list[i].y == this.y){
				...
				if (koma_list[i].side != this.side){
					...
					Object.keys(gattai_koma_list).forEach( function(key) {
						let value = this[key];
						if (value[0] == selected_obj.constructor.name && value[1] == koma_list[i].constructor.name
							|| value[1] == selected_obj.constructor.name && value[0] == koma_list[i].constructor.name){
							make_gattai_koma_functions[key];
						}
					}, gattai_koma_list);
...
var make_gattai_koma_functions = {
	"KNGN" : new KNGN(selected_obj.x, selected_obj.y, selected_obj.side),
	"KNKY" : new KNKY(selected_obj.x, selected_obj.y, selected_obj.side),
	"KNKM" : new KNKM(selected_obj.x, selected_obj.y, selected_obj.side),
	"KNHS" : new KNHS(selected_obj.x, selected_obj.y, selected_obj.side),
	"KNKK" : new KNKK(selected_obj.x, selected_obj.y, selected_obj.side),
	"KNFU" : new KNFU(selected_obj.x, selected_obj.y, selected_obj.side),
	"GNKY" : new GNKY(selected_obj.x, selected_obj.y, selected_obj.side),
	"GNKM" : new GNKM(selected_obj.x, selected_obj.y, selected_obj.side),
	"GNHS" : new GNHS(selected_obj.x, selected_obj.y, selected_obj.side),
	"GNKK" : new GNKK(selected_obj.x, selected_obj.y, selected_obj.side),
	"GNFU" : new GNFU(selected_obj.x, selected_obj.y, selected_obj.side),
	"KYKM" : new KYKM(selected_obj.x, selected_obj.y, selected_obj.side),
	"KYHS" : new KYHS(selected_obj.x, selected_obj.y, selected_obj.side),
	"KYKK" : new KYKK(selected_obj.x, selected_obj.y, selected_obj.side),
	"KYFU" : new KYFU(selected_obj.x, selected_obj.y, selected_obj.side),
	"KMHS" : new KMHS(selected_obj.x, selected_obj.y, selected_obj.side),
	"KMKK" : new KMKK(selected_obj.x, selected_obj.y, selected_obj.side),
	"KMFU" : new KMFU(selected_obj.x, selected_obj.y, selected_obj.side),
	"HSKK" : new HSKK(selected_obj.x, selected_obj.y, selected_obj.side),
	"HSFU" : new HSFU(selected_obj.x, selected_obj.y, selected_obj.side),
	"KKFU" : new KKFU(selected_obj.x, selected_obj.y, selected_obj.side)
}
